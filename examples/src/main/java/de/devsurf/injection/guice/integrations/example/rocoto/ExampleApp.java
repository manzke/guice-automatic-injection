...
public class ExampleApp implements ExampleApplication{
    @Override
    public void run(){
	StartupModule startupModule = new ConfigurationStartupModule(ASMClasspathScanner.class, ExampleApp.class.getPackage().getName(), ConfigurationStartupModule.class.getPackage().getName());
