...
import de.devsurf.injection.guice.integrations.rocoto.ConfigurationModuleInstaller;
...
public class ExampleApp implements ExampleApplication{
    @Override
    public void run(){
	StartupModule startupModule = StartupModule.create(ASMClasspathScanner.class, ExampleApp.class.getPackage().getName(), ConfigurationModuleInstaller.class.getPackage().getName());
	startupModule.addFeature(RocotoConfigurationFeature.class);
