...
public class DirectOverrideConfigTests {
    ...
    @Configuration(name = @Named("direct"), location = @PathConfig(path="http://devsurf.de/guice/configuration.properties", type=PathType.URL), override=@PathConfig(path="http://devsurf.de/guice/nonexisting.properties" ,type = PathType.URL))
