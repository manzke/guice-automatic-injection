...
public class FileConfigTests {
    ...
    @de.devsurf.injection.guice.configuration.Configuration(name = "config", bind = PropertyListConfiguration.class, path = "src/test/resources/configuration.plist", pathType = PathType.FILE)
