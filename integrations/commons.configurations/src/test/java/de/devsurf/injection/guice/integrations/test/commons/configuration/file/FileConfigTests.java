...
public class FileConfigTests {
    ...
    @de.devsurf.injection.guice.configuration.Configuration(name = "config", bind = PropertyListConfiguration.class, path = "src/test/java/configuration.plist", pathType = PathType.FILE)
