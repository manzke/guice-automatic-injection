 ...
 */
package de.devsurf.injection.guice.scanner.sonatype.tests.autobind.multiple;
...
public class MultibindTests {
	...
	Injector injector = Guice.createInjector(StartupModule.create(SonatypeScanner.class, MultibindTests.class.getPackage().getName()));
	assertNotNull(injector);
    }
    
    @Test
    public void testWithWrongPackage1(){
	Injector injector = Guice.createInjector(StartupModule.create(SonatypeScanner.class, "java"));
	assertNotNull(injector);
