 ...
 */
package de.devsurf.injection.guice.scanner.reflections.tests.autobind;
...
public class AutobindTests {
	...
	Injector injector = Guice.createInjector(StartupModule.create(ReflectionsScanner.class, AutobindTests.class.getPackage().getName()));
